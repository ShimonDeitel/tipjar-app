...
struct ContentView: View {
    @EnvironmentObject var store: TipjarStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: TipjarEntry?
    ...
    private func entryRow(_ entry: TipjarEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: TipjarEntry? = nil, onSave: @escaping (String, Double) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existing == nil ? "Add Shift" : "Edit Shift")
